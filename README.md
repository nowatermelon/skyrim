...
## Introduction
**Bread** is a complete overhaul modlist for Skyrim AE (1.6.1170) with all AE content, built around [Community Shaders](https://www.nexusmods.com/skyrimspecialedition/mods/86492). It significantly expands content across all aspects (at ~170 esp slots), aiming to breathe lasting vitality into Skyrim and deliver a deeply immersive experience, while striving to remain lore-friendly.
...
2. **Steam**
   ...
   - Upon first launch, the game will auto-download the DLCs. If not, register an account with Bethesda and then restart the game. Do not switch away from the window until the download is complete.
